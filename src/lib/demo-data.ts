...
export const INTAKE_LANGUAGES = {
  en: {
    ...
    fields: {
      ...
      namePlaceholder: "e.g., CloudScale Infotech Solutions",
      ...
      goals: "Primary Goals",
      goalsPlaceholder: "e.g., Automate client onboarding, SLA tracking, launch portal",
  ...
  hi: {
    ...
    fields: {
      ...
      namePlaceholder: "उदा. क्लाउडस्केल इन्फोटेक सॉल्यूशंस",
      ...
      goalsPlaceholder: "उदा. क्लाइंट ऑनबोर्डिंग, SLA ट्रैकिंग और सर्विस पोर्टल शुरू करना",
...
export const HR_CRM_CANDIDATES: CRMCandidate[] = [
  { id: "c001", name: "Priya Sharma", email: "priya.sharma@mail.com", role: "Senior Java Developer", experience: 7, stage: "Interview", rating: 4, status: "Active", appliedDate: "2026-09-01", notes: "Strong Spring Boot experience. Cleared round 1.", customValues: { noticePeriod: "15 Days", expectedCtc: "₹24 LPA", linkedinUrl: "https://linkedin.com/in/priya-sharma-dev" } },
  { id: "c002", name: "Rahul Verma", email: "rahul.v@mail.com", role: "React Frontend Engineer", experience: 4, stage: "Screening", rating: 3, status: "Active", appliedDate: "2026-09-03", notes: "Portfolio looks promising. Needs technical assessment.", customValues: { noticePeriod: "Immediate", expectedCtc: "₹14 LPA", linkedinUrl: "https://linkedin.com/in/rahul-verma-ui" } },
  { id: "c003", name: "Ananya Desai", email: "ananya.d@mail.com", role: "Product Manager", experience: 6, stage: "Offer", rating: 5, status: "Active", appliedDate: "2026-08-25", notes: "Exceptional PM skills. Client approved. Offer at ₹18L CTC.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹18 LPA", linkedinUrl: "https://linkedin.com/in/ananya-desai-pm" } },
  { id: "c004", name: "Vikram Patel", email: "vikram.p@mail.com", role: "DevOps Engineer", experience: 5, stage: "Interview", rating: 4, status: "Active", appliedDate: "2026-09-02", notes: "Strong AWS + Kubernetes. Round 2 scheduled.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹20 LPA", linkedinUrl: "https://linkedin.com/in/vikram-patel-cloud" } },
  { id: "c005", name: "Meera Krishnan", email: "meera.k@mail.com", role: "Data Analyst", experience: 3, stage: "Screening", rating: 3, status: "Active", appliedDate: "2026-09-05", notes: "Good SQL and Tableau skills. Entry-level position.", customValues: { noticePeriod: "Immediate", expectedCtc: "₹9 LPA", linkedinUrl: "https://linkedin.com/in/meera-krishnan-data" } },
  { id: "c006", name: "Arjun Nair", email: "arjun.n@mail.com", role: "Senior Java Developer", experience: 9, stage: "Rejected", rating: 2, status: "Withdrawn", appliedDate: "2026-08-20", notes: "Withdrawn after receiving competing offer.", customValues: { noticePeriod: "60 Days", expectedCtc: "₹30 LPA", linkedinUrl: "https://linkedin.com/in/arjun-nair" } },
  { id: "c007", name: "Sneha Gupta", email: "sneha.g@mail.com", role: "QA Lead", experience: 8, stage: "Offer", rating: 5, status: "Active", appliedDate: "2026-08-28", notes: "Excellent automation expertise. Final negotiation stage.", customValues: { noticePeriod: "15 Days", expectedCtc: "₹22 LPA", linkedinUrl: "https://linkedin.com/in/sneha-gupta-qa" } },
  { id: "c008", name: "Karthik Rajan", email: "karthik.r@mail.com", role: "Full Stack Developer", experience: 3, stage: "Interview", rating: 3, status: "Active", appliedDate: "2026-09-04", notes: "MERN stack. Cleared coding round, HR interview pending.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹12 LPA", linkedinUrl: "https://linkedin.com/in/karthik-rajan" } },
  { id: "c009", name: "Divya Iyer", email: "divya.i@mail.com", role: "UI/UX Designer", experience: 5, stage: "Screening", rating: 4, status: "Active", appliedDate: "2026-09-06", notes: "Strong Figma portfolio. Scheduled initial screen.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹16 LPA", linkedinUrl: "https://linkedin.com/in/divya-iyer-design" } },
  { id: "c010", name: "Rohit Saxena", email: "rohit.s@mail.com", role: "Backend Engineer (Node.js)", experience: 4, stage: "Rejected", rating: 2, status: "Active", appliedDate: "2026-08-22", notes: "Did not clear system design round. May re-apply in 6 months.", customValues: { noticePeriod: "Immediate", expectedCtc: "₹15 LPA", linkedinUrl: "https://linkedin.com/in/rohit-saxena" } },
  { id: "c011", name: "Isha Malhotra", email: "isha.m@mail.com", role: "HR Business Partner", experience: 6, stage: "Interview", rating: 4, status: "On Hold", appliedDate: "2026-09-01", notes: "Client budget approval pending. Strong HRBP background.", customValues: { noticePeriod: "45 Days", expectedCtc: "₹17 LPA", linkedinUrl: "https://linkedin.com/in/isha-malhotra" } },
  { id: "c012", name: "Aditya Joshi", email: "aditya.j@mail.com", role: "Cloud Architect", experience: 10, stage: "Offer", rating: 5, status: "Active", appliedDate: "2026-08-18", notes: "AWS Solutions Architect Pro certified. Negotiating ₹35L package.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹35 LPA", linkedinUrl: "https://linkedin.com/in/aditya-joshi-cloud" } },
  { id: "c013", name: "Nandini Rao", email: "nandini.r@mail.com", role: "React Frontend Engineer", experience: 2, stage: "Screening", rating: 3, status: "Active", appliedDate: "2026-09-07", notes: "Fresh bootcamp grad with good project work. Junior position.", customValues: { noticePeriod: "Immediate", expectedCtc: "₹8 LPA", linkedinUrl: "https://linkedin.com/in/nandini-rao" } },
  { id: "c014", name: "Siddharth Menon", email: "sid.m@mail.com", role: "Technical Lead", experience: 12, stage: "Interview", rating: 5, status: "Active", appliedDate: "2026-08-30", notes: "Lead architect at previous company. Final panel interview next week.", customValues: { noticePeriod: "60 Days", expectedCtc: "₹42 LPA", linkedinUrl: "https://linkedin.com/in/siddharth-menon" } },
  { id: "c015", name: "Lakshmi Venkat", email: "lakshmi.v@mail.com", role: "Data Analyst", experience: 4, stage: "Rejected", rating: 3, status: "Active", appliedDate: "2026-08-24", notes: "Good skills but lacked domain-specific experience for client requirement.", customValues: { noticePeriod: "30 Days", expectedCtc: "₹11 LPA", linkedinUrl: "https://linkedin.com/in/lakshmi-venkat" } },
];
